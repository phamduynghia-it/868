...
const NUMBER_OF_IMAGES = 15; // <--- CHỈ CẦN THAY ĐỔI SỐ NÀY
...
popupImg.addEventListener("click", () => {
    const message = `Giáng sinh lại đến rồi, và điều anh mong nhất vẫn chỉ là thấy em cười bình yên bên cạnh anh. Cảm ơn em vì đã làm ngày tháng của anh ấm áp hơn cả những ánh đèn Noel ngoài phố. Chúc em một mùa Giáng sinh ngọt ngào, an lành và luôn được yêu thương… đặc biệt là bởi anh. Merry Christmas, my love.`;
